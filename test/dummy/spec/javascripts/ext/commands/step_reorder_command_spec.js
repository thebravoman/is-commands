...
describe("ChangeParentCommand", function() {
	...
	describe('throws error on construction', function() {
	    ...
	    expect(function() {new IS.Commands.StepReorderCommand(null, {}, 1)}).toThrow(new Error("Null argument passed."));
		})
		...
		it("for when the step has no parent", function() {
			expect(function() {new IS.Commands.StepReorderCommand({},{}, 1)}).toThrow(new Error("Null argument passed."));
		})
	})
